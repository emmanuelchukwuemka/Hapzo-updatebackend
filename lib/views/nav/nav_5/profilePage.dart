...
import 'package:haptext_api/controllers/authentication/log_out_controller.dart';
            ...
            itemBuilder: (BuildContext context) => [
              PopupMenuItem(
                child: InkWell(
                  onTap: () {
                    Navigator.push(
                        context, MaterialPageRoute(builder: (_) => PostTest()));
                  },
                                  ...
                                  Expanded(
                                    ...
                                    child: Padding(
                                      ...
                                      child: InkWell(
                                        ...
                                        child: Text(
                                          _userData?.bio ?? 'This is what you need to know about me... A Mobile Developer with an enthusiasm for knowledge and inventions.',
                                          style: const TextStyle(
                                            // color: context.theme.textColor,
                                            fontSize: 12.0,
                ...
                GestureDetector(
                  onTap: () {
                    Navigator.push(
                      ...
                      newData = await userController.fetchUserData();
                      setState(() {
                        _userData = newData;
                      });
                    });
