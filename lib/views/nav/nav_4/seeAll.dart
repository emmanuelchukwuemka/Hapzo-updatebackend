    ...
    return DefaultTabController(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          title: Text('@Roman Fortune', style: TextStyle(color: context.theme.titleTextColor, fontWeight: FontWeight.bold)),
          ...
          bottom: TabBar(
            ...
            tabs: [
              Tab(child: Column(crossAxisAlignment: CrossAxisAlignment.center, children: [Text('Photos'), Text('947')]), icon: Icon(Icons.photo),),
              Tab(child: Column(crossAxisAlignment: CrossAxisAlignment.center, children: [Text('Videos'), Text('1.5k')]), icon: Icon(Icons.video_library_sharp),),
              Tab(child: Column(crossAxisAlignment: CrossAxisAlignment.center, children: [Text('Audios'), Text('29')]), icon: Icon(Icons.audiotrack),),
              Tab(child: Column(crossAxisAlignment: CrossAxisAlignment.center, children: [Text('Texts'), Text('115')]), icon: Icon(Icons.text_snippet),),
            ],
          ),
        ),
        body: TabBarView(
