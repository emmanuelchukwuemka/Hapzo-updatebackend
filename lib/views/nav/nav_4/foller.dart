      ...
      : Column(
          children: [
            ...
            _userData!.followers!.isEmpty
                ...
                : Expanded(
                    child: Padding(
                      padding: const EdgeInsets.only(bottom: 7.50, left: 5.0, right: 5.0),
                      child: GridView.builder(
                        ...
                        itemBuilder: (context, index) => FriendCardWidget(context, _userData!.followers![index], 'assets/images/me.jpg'),
                      ),
                    ),
                ),
          ]
