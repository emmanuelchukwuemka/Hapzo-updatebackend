...
class ExploreCarousel extends StatefulWidget {
  final String title;
  ExploreCarousel({Key? key, required this.title}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          Padding(
            padding: const EdgeInsets.only(left: 10, top: 15, bottom: 5.0,),
            child: Align(
              alignment: Alignment.topLeft,
              child: Text(
                widget.title,
                style: TextStyle(color: context.theme.titleTextColor, fontSize: 15.0, fontWeight: FontWeight.w500),
          ...
          Expanded(
            child : GridView.builder(
              ...
              itemBuilder: (context, index) => ExploreItem(size: size, imgPath: _imgs[index], fileType: _type[index], category: _icn[index],),
              // children: [
          ...
          InkWell(
            ...
            child: Padding(
              ...
              child: Align(
                ...
                child: Text('See more', style: TextStyle(color: context.theme.primaryColor, fontSize: 12,), textAlign: TextAlign.right,),
              ),
            ),
          ),
        ],
        ...
        Align(
          ...
          child: Container(
            ...
            child: Container(
              ...
              child: Center(
                child: Icon(category, color: fileType, size: 14,),
              ),
            ),
          ),
